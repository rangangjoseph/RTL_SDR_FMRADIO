...
class fmradio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = Range(850e5, 1100e5, 1, 103304e3, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 100000, 75000, firdes.WIN_HAMMING, 6.76))
